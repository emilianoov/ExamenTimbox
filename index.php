            ...
            <div class="d-table-cell">
                <div class="login-form">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            <div class="forgot">
                                <a href="views\password" class="forgot-password">Olvidaste la contraseña?</a>
                            </div>
                        </div>
                        <input type="hidden" name="enviar" value="si">
                        <button type="submit" class="login-btn">Ingresar</button>

                        <p class="mb-0">No tienes una cuenta? <a href="views\register\register.php">Registrate</a></p>
                    </form>
                </div>
            </div>
        </div>
